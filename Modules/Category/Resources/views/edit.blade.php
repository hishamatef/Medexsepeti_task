                    ...
                    <div class="col-lg-6 col-7">
                        ...
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{__('category::category.edit_category')}}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{__('category::category.edit_category')}}</h3>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="card-body">
                                        <form action="{{Route('categories.update', $category->id)}}" method="post">
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <button type="submit" class="btn btn-primary mt-3">{{__('category::category.edit_category')}}</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
