...
class BrandServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->when(BrandController::class)->needs(CrudInterface::class)->give(BrandService::class);
        $this->app->when(BrandApiController::class)->needs(CrudInterface::class)->give(BrandService::class);
    }
